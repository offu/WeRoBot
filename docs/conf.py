...
# documentation.
html_theme_options = {"touch_icon": "logo.png", "github_url": "offu/WeRoBot"}
...
latex_documents = [
    ("index", "WeRoBot.tex", u"WeRoBot Documentation", u"offu", "manual")
]
...
man_pages = [("index", "werobot", u"WeRoBot Documentation", [u"offu"], 1)]
